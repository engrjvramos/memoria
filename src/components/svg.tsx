...
const Feather = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" width="1em" height="1em" viewBox="0 0 29 28" {...props}>
    <g fill="currentColor" fillRule="evenodd" clipPath="url(#a)" clipRule="evenodd">
      <path d="M27.9 2.158C26.867.192 23.474.81 20.54 1.595 7.791 6.293 3.281 15.841 1.696 21.53a1.051 1.051 0 0 0-.13.481c-.628 2.414-.713 4.023-.714 4.076a1.048 1.048 0 0 0 1.003 1.09c.016.002.031.002.047.002.558 0 1.023-.441 1.048-1.005.007-.171.072-1.346.468-3.101 3.511-.149 7.046-1.457 10.518-3.898a1.05 1.05 0 0 0 .049-1.681l-1.602-1.269 5.256-.515c.214-.021.416-.107.58-.247a80.005 80.005 0 0 0 5.333-5.055c3.872-4.06 5.211-6.604 4.348-8.25ZM21.678 25.08h-8.974a1.05 1.05 0 0 0 0 2.1h8.974a1.05 1.05 0 0 0 0-2.1Z" />
    </g>
    <defs>
      <clipPath id="a">
...
export { Discord, Feather, GitHub, Gmail, Google, LinkedIn, NoData, Telegram };
